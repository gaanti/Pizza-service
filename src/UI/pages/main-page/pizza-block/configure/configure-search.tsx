...
function ConfigureSearch(props: {  searchIngredient: string;  searchIngredientArray: string[]; setSearchIngredient: React.Dispatch<React.SetStateAction<string>>; setIngredient(toSet: string[]): void, ingredients: string[] }) {
      return (
