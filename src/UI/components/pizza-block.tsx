                  ...
                  <div className="pizza-block">
                        ...
                        <div className="pizza-block__selector">
                              <div className="pizza-block__description_and_params">
                                    <p>The term originally referred to messages sent using the Short Message Service (SMS). It has grown</p>
                                    <div>
                                          <h5>
                        ...
                        <div className="pizza-block__bottom">
                              ...
                              <div
                                    className="button button-black-white pizza-block__configure_button"
