...
const PopUp = forwardRef(
      (
            ...
            const click = (event: any) => {
                  ...
                  console.log(ref);
                  if (!event.composedPath().includes(ref.current) && ref.current != null) {
            ...
            function setIngredient(event: any, toSet: string[]) {
                                                ...
                                                {searchIngredientArray.map((v) => {
                                                      return (
                                                            <li>
                                                                  ...
                                                                  <p
                                                                        onClick={(e) => {
                                                                              /*setIngredient(e, [...props.ingredients, v]);*/
                                                                              /*props.setIngredients([...props.ingredients, v]);*/
                                                                              props.rerenderParent(!props.parent);
                                                                        }}>
                                                                        +
